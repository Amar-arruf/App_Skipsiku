            ...
            <div class="card-body px-0 pb-2">
              <form action="" class="mt-2 ms-3" method="POST">
                <div class="row mb-3">
                  ...
                  <div class="col-sm-8">
                    <div class="input-group input-group-dynamic">
                      <input type="text" class="form-control" name="alternatifID" readonly value="<?= $dat['Alternatif_id']; ?>">
                    </div>
                  </div>
                </div>
                <div class="row mb-3">
                  ...
                  <div class="col-sm-8">
                    <div class="input-group input-group-dynamic">
                      <input type="text" class="form-control" readonly value="<?= $dat['user_id']; ?>" name="userID">
                    </div>
                  </div>
                </div>
                <div class="row mb-3">
                  ...
                  <div class="col-sm-8">
                    <div class="input-group input-group-dynamic">
                      <input type="text" class="form-control" name="nama" value="<?= $dat['name']; ?>">
                    </div>
                  </div>
                </div>
                <div class="row mb-3">
                  ...
                  <div class="col-sm-8">
                    <div class="input-group input-group-dynamic">
                      <input type="text" class="form-control" name="ttl" value="<?= $dat['Tanggal_Lahir']; ?>">
                    </div>
                  </div>
                </div>
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-8">
                    <div class="input-group input-group-dynamic">
                      <textarea class="form-control" rows="4" placeholder="Alamat" spellcheck="false" name="alamat"><?= $dat['Alamat']; ?></textarea>
                    </div>
                  </div>
                </div>
