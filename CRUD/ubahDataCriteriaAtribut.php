<?php 
  ...
  $dat = query("SELECT * FROM `criteias` WHERE criteria_id = '$id'")[0];
  
  $QueryUbah = "UPDATE `criteias` SET
...
<head>
  ...
  <title>Halaman Dashboard | Tambah Data Criteria Atribut</title>
</head>
            ...
            <div class="card-body px-0 pb-2">
              <form  class="mt-2 ms-3" method="POST">
                <div class="row mb-3">
                  ...
                  <div class="col-sm-8">
                    <div class="input-group input-group-dynamic">
                      <input type="text" class="form-control" name="criteriaid" readonly value="<?= $dat["criteria_id"] ?>">
                    </div>
                  </div>
                </div>
                <div class="row mb-3">
                  ...
                  <div class="col-sm-8">
                    <div class="input-group input-group-dynamic">
                      <select class="form-control" id="exampleFormControlSelect1" name="userid">
                        <option value="<?= $dat["user_id"]; ?>"><?= $dat["user_id"]; ?></option>
                      </select>
                    </div>
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-8">
                    <div class="input-group input-group-Dynamic">
                      <input type="text" class="form-control" name="type" value="<?= $dat["type"] ?>">
                    </div>
                  </div>
                </div>
