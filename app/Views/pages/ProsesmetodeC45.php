      ...
      <div class="card my-4">
        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
          <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
            <h6 class="text-white text-capitalize ps-4">Import Data Latih</h6>
          </div>
        </div>
          ...
          <div class="table-responsive p-0">
            <table class="table align-intems-center mb-0">
              ...
              <tbody>
                ...
                <?php $i = 1; ?>
                <?php foreach($datasetslist as $row) : ?>
                <tr>
  ...
  <div class="row">
    <div class="col-12">
      <div class="card my-4">
        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
          <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
            <h6 class="text-white text-capitalize ps-4">Import Data Uji</h6>
          </div>
        </div>
        <div class="card-body px-0 pb-2">
          <!-- Import data -->
          ...
          <div class="card-body px-3 pb-2">
            <div class="table-responsive p-0">
              <table class="table-align-items-center d-flex flex-column align-items-center justify-content-center mb-0">
                ...
                <tbody>
                  <?php $i = 1; ?>
                  <?php foreach($prosesc45['prediksi'] as $row) : ?>
                    <tr>
                      <td>
                        <div class="align-middle text-center text-sm">
                          <p class="text-xs font-weight-bold mb-0 me-3 p-3"><?= "T".$i ?></p>
                        </div>
                      </td>
                      <td>
                        <div class="align-middle text-center text-sm">
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <form action="<?= base_url('prosesmetodec45/importcsv') ?>"  class="mt-2" method="POST" enctype="multipart/form-data">
...
<!-- Modal import Data uji -->
<div class="modal fade" id="exampleModal1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title font-weight-normal" id="exampleModalLabel">Form Upload CSV Data Uji</h5>
        <button type="button" class="btn-close text-dark" data-bs-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <form action="<?= base_url('prosesmetodec45/importcsvdatauji') ?>"  class="mt-2" method="POST" enctype="multipart/form-data">
        <div class="modal-body">
          <label class="form-label">Upload File</label>
          <div class=" input-group input-group-outline mb-3">
            <input class="form-control" type="file" name="FileCSV">
