...
$id = $_GET["id"];
$sql = "SELECT `criteria_id` FROM `criteias` WHERE `criteria_id` = '$id'";
$getQuery = query($sql);
$QueryTambah = "INSERT INTO `criterias_option`
                VALUES
                ('$criteriaoptionid','$CriteriaID','$kriteria','$klasifikasi','$value',current_timestamp(),NULL);
               "
...
<head>
  ...
  <title>Halaman Dashboard | Tambah Data Criteria Value</title>
</head>
<body class="g-sidenav-show bg-gray-300 g-sidenav-pinned">
  ...
  <main class="main-content position-rlative max-height-vh-100 h-100 border-radius-lg">
    <!-- Navbar -->
    <nav 
